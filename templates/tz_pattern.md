...
| 1.0 | ELEMENT-895 - Сервис отпусков_Виджет ЗАКРЫТ | - | v.8 | PO - Тяхт Всеволод<br>Заказчик - Тяхт Всеволод<br>TL - Тяхт Всеволод |
| 1.1. | - | В версии 1.0 реализовали иначе, чем описано. Внесены правки чтобы документ соответствовал фактической реализации. | - | - |
| 1.2. | ELEMENT-1750 - Рефакторинг_Виджет ЗАКРЫТ | Добавили новую функцию просмотра истории сообщений | v.10 | PO - Тяхт Всеволод<br>Заказчик - Тяхт Всеволод<br>TL - Тяхт Всеволод |
