...
ТЕХНИЧЕСКИЕ ДЕТАЛИ:
- Все требования из ТЗ должны быть упомянуты
- Сохраняй логическую структуру документа
- Превращай таблицы в рэп-строки
- Номера версий, статусы Jira, имена согласователей - всё идёт в текст
- Метрики производительности зачитывай как достижения
